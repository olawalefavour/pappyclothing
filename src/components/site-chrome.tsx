...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 md:bottom-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-110 transition-transform"
    >
